                            ...
                            <div class="col-xs-12">
                                <div class="deal-deatails panel">
                                    ...
                                    <div class="deal-body p-20">
                                        <h3 class="mb-10">مكبر الشاشة الجوال ثلاثي الأبعاد مع سماعة</h3>
                                    ...
                                    <i class="fa fa-star-o"></i>
                                        ...
                                        <p class="mb-15">خلافاَ للإعتقاد السائد فإن لوريم إيبسوم ليس نصاَ عشوائياً، بل إن له جذور في الأدب اللاتيني الكلاسيكي منذ العام 45 قبل الميلاد، مما يجعله أكثر من 2000 عام في القدم. قام البروفيسور "ريتشارد ماك لينتوك" (Richard McClintock) وهو بروفيسور اللغة اللاتينية في جامعة هامبدن-سيدني في فيرجينيا بالبحث عن أصول كلمة لاتينية غامضة في نص لوريم إيبسوم وهي "consectetur"، وخلال تتبعه لهذه الكلمة في الأدب اللاتيني اكتشف المصدر الغير قابل للشك.</p>
                                        <p class="mb-15">هنالك العديد من الأنواع المتوفرة لنصوص لوريم إيبسوم، ولكن الغالبية تم تعديلها بشكل ما عبر إدخال بعض النوادر أو الكلمات العشوائية إلى النص. إن كنت تريد أن تستخدم نص لوريم إيبسوم ما، عليك أن تتحقق أولاً أن ليس هناك أي كلمات أو عبارات محرجة أو غير لائقة مخبأة في هذا النص.</p>
                                        <p class="mb-20">ينما تعمل جميع مولّدات نصوص لوريم إيبسوم على الإنترنت على إعادة تكرار مقاطع من نص لوريم إيبسوم نفسه عدة مرات بما تتطلبه الحاجة، يقوم مولّدنا هذا باستخدام كلمات من قاموس يحوي على أكثر من 200 كلمة لا تينية.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="posted-review panel p-30">
                                    <h3 class="h-title">16 تقييم</h3>
                                    <div class="review-single pt-30">
                                        <div class="media">
                                            <div class="media-right">
                                                <img class="media-object ml-10 radius-4" src="{{asset('public/front/assets/images/avatars/avatar_01.jpg')}}" width="90" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="review-wrapper clearfix">
                                                    <ul class="list-inline">
                                                        <li>
                                                            <span class="review-holder-name h5">احمد ابو زيد</span>
                                                        </li>
                                                        <li>
                                                            <div class="rating">
                                                    ...
                                                    <p class="review-date mb-5">9 سبتمبر، 2016</p>
                                                    <p class="copy">كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما قامت مطبعة مجهولة برص مجموعة من الأحرف بشكل عشوائي أخذتها من نص، لتكوّن كتيّب بمثابة دليل أو مرجع شكلي لهذه الأحرف.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="review-single pt-30">
                                        <div class="media">
                                            <div class="media-right">
                                                <img class="media-object ml-10 radius-4" src="{{asset('public/front/assets/images/avatars/avatar_02.jpg')}}" width="90" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="review-wrapper clearfix">
                                                    <ul class="list-inline">
                                    ...
                                    <div class="review-single pt-30">
                                        <div class="media">
                                            <div class="media-right">
                                                <img class="media-object ml-10 radius-4" src="{{asset('public/front/assets/images/avatars/avatar_03.jpg')}}" width="90" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="review-wrapper clearfix">
                                                    <ul class="list-inline">
                                    ...
                                    <div class="review-single pt-30">
                                        <div class="media">
                                            <div class="media-right">
                                                <img class="media-object ml-10 radius-4" src="{{asset('public/front/assets/images/avatars/avatar_04.jpg')}}" width="90" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="review-wrapper clearfix">
                                                    <ul class="list-inline">
                                    ...
                                    <div class="review-single pt-30">
                                        <div class="media">
                                            <div class="media-right">
                                                <img class="media-object ml-10 radius-4" src="{{asset('public/front/assets/images/avatars/avatar_05.jpg')}}" width="90" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="review-wrapper clearfix">
                                                    <ul class="list-inline">
                                ...
                                <div class="post-review panel p-20">
                                    ...
                                    <form class="horizontal-form pt-30" action="#">
                                        <div class="row row-v-10">
                                            ...
                                            <div class="col-xs-12">
                                                <textarea class="form-control" placeholder="تقييمك" rows="6"></textarea>
                                            </div>
                                            <div class="col-xs-12 text-left">
                                                <button type="submit" class="btn mt-20">انشر التقييم</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="widget single-deal-widget panel ptb-30 prl-20">
                                        <div class="widget-body text-center">
                                            <h2 class="mb-20 h3">
                                            مكبر الشاشة الجوال ثلاثي الأبعاد مع سماعة
                                                </h2>
                                            <ul class="deal-meta list-inline mb-10 color-mid">
                                                <li><i class="ico fa fa-globe ml-10"></i><a href="#" class="color-mid">Ebay</a></li>
                                            ...
                                            <div class="buy-now mb-40">
                                                <a href="#" target="_blank" class="btn btn-block btn-lg">
                                                    <i class="fa fa-shopping-cart font-16 ml-10"></i> اشتري الآن
                                                </a>
                                            </div>
                                            <div class="time-right mb-30">
                                                <p class="t-uppercase color-muted">
                                                    عجلوا لم يتبق سوى عدد قليل من الصفقات
                                                </p>
                                                <h5 class="color-mid font-14 font-lg-16">
