...
@section('content')
	 ...
	 <main id="mainContent" class="main-content">
        ...
        <section id="main">
            ...
            <h1 class="page-title text-center">نتائح البحث</h1>
          ...
          <div class="content-404 col-lg-6 col-sm-6 text-center">
              ...
              <div class="info"><p>البحث مجددا</p></div>
              <a class="btn btn-primary mb-35 mt-15" href="{{route('home-ar')}}"><i class="fa"></i><span>العودة لرئيسية</span></a>
