                                ...
                                <div class="deal-deatails panel">
                                    <div class="deal-slider">
                                        <div id="product_slider" class="flexslider">
                                            <ul class="slides">
                                                <li>
                                                    <img alt="" src="{{asset('public//backend/dist/img/deal_images/'.$deal['main_image'])}} ">
                                                </li>
                                                <li>
                                    ...
                                    <div class="deal-body p-20">
                                        ...
                                        <p class="mb-15"> {{$deal['description']}}</p>
                                    ...
                                    <div class="widget about-seller-widget panel ptb-30 prl-20">
                                        ...
                                        <div class="widget-body t-center">
                                            ...
                                            <div class="store-about mb-20">
                                                ...
                                                <p class="mb-15">{{$deal->store['description']}}</p>
                                                <button class="btn btn-info" href="#">FOLLOW</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Recent Posts -->
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="widget contact-us-widget panel pt-20 prl-20">
                                        ...
                                        <div class="widget-body ptb-30">
                                            ...
                                            <a href="{{route('contact')}}" class="btn btn-block"><i class="mr-10 font-15 fa fa-envelope-o"></i>Drop Us a Line</a>
                                        </div>
                                    </div>
