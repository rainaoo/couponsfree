...
<html>
  <head>
    <meta charset="UTF-8">
    <title>AdminLTE  | لوحة تحكم</title>
            ...
            <ul class="nav navbar-nav">
               ...
               <li class="dropdown lang-menu">
                ...
                <ul class="dropdown-menu">
                 <li class="header"><a href="index2.html">الانجليزية</a></li> 
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>لوحة تحكم</span> <i class="fa fa-angle-left pull-left"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{route('dashboard_en')}}"><i class="fa fa-circle-o"></i> لوحة تحكم بالانجليزي</a></li>
                <li><a href="{{route('dashboard_ar')}}"><i class="fa fa-circle-o"></i> لوحة تكم بالعربي</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
