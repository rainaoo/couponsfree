...
<html>
  <head>
    <meta charset="UTF-8">
    <title>AdminLTE en| Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Admin</b>LTR</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown lang-menu">
                ...
                <ul class="dropdown-menu">
                 <li class="header"><a href="index.html">Arabic</a></li> 
                 <!-- <a href="index2.html"><li class="header"></li>الانجليزية</li></a> -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('dashboard_en')}}"><i class="fa fa-circle-o"></i> Dashboard english</a></li>
                <li class="active"><a href="{{route('dashboard_ar')}}"><i class="fa fa-circle-o"></i> Dashboard arabic</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('addpage')}}"><i class="fa fa-circle-o"></i> Home</a></li>
                <li><a href="{{route('company.page.add')}}"><i class="fa fa-circle-o"></i> About</a></li>
                <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Post</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('show-post')}}"><i class="fa fa-circle-o"></i> show posts</a></li>
                <li><a href="{{route('addpost')}}"><i class="fa fa-circle-o"></i> Add posts</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('banners')}}"><i class="fa fa-circle-o"></i> show banners</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('stores')}}"><i class="fa fa-circle-o"></i> show stores</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('Categories')}}"><i class="fa fa-circle-o"></i> show Categories</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('coupons')}}"><i class="fa fa-circle-o"></i> show coupons</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('deals')}}"><i class="fa fa-circle-o"></i> show deals</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{route('blog')}}"><i class="fa fa-circle-o"></i> show blogs</a></li>
...
<!-- custom admin js for delete-->
<script src="{{ url('public/backend/dist/js/admin_script.js') }}"></script>
